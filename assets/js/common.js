...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShareNav = (function (_React$Component) {
	    _inherits(ShareNav, _React$Component);
	
	    function ShareNav() {
	        _classCallCheck(this, ShareNav);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ShareNav).apply(this, arguments));
	    }
